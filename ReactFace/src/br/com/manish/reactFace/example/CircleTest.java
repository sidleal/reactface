...
public class CircleTest extends ReactFaceApplication {

	@Override
	public void start() {
		
		//Initial JavaFX configs
		setTitle("ReactFace Example - Circles");
        setWidth(800.0);
        setHeight(600.0);
        
        MyCircle blue = new MyCircle(); //Creating a first object
        addObject(39, blue); //Adding on group root and putting on fiducials map

        MyCircle red = new MyCircle(Color.RED); //Creating a second object
